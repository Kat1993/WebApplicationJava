  ...
  <div id="wrapper">
    ...
    <section id="content">
      ...
      <div class="container">
        <div class="row">
          <div class="span8">
            <h4 class="title"><strong>Welcome ${LoggedInuser.firstName}</strong> !!
...
<div class="span4">
              ...
              <div class="row">
                ...
                <input type ="text" name ="id" value ="${LoggedInuser.id}">
...
<span class="text-danger text-center">${error}</span>  
              ...
              <div class="widget">
                <h5 class="widgetheading">${LoggedInuser.firstName} ${LoggedInuser.lastName}<span></span></h5>
