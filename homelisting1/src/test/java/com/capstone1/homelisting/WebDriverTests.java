package com.capstone1.homelisting;
...
static String url="http://localhost:2000/capstone1";
...
driver.get("http://localhost:2000/capstone1/login");
driver.findElement(By.id("user")).sendKeys("tsymbal.katena@gmail.com");
//Thread.sleep(3000);
...
driver.get("http://localhost:2000/capstone1/"+page+"");
...
public void testEmail() {
	...
	driver.findElement(By.id("name")).sendKeys("Kateryna Tsymbal");
	driver.findElement(By.id("email")).sendKeys("tsymbal.katena@gmail.com");
	driver.findElement(By.id("subject")).sendKeys("Web Driver Test Email");
	driver.findElement(By.id("msg")).sendKeys("this is the test ");
